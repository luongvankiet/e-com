...
export default function CategoryDataTableRow({
  category,
  selected,
  onSelectRow,
  onEditRow,
  ...
  const handlePublish = (event) => {
    router.put(route(routes.dashboard.categories.update, id), {
      ...category,
      ...
      <TableRow hover selected={selected}>
        ...
        >
          ...
          <Link
            ...
            href={route(routes.dashboard.categories.edit, id)}
        ...
        <TableCell>
          {parent ? (
            <Link
              component={RouterLink}
              href={route(routes.dashboard.categories.edit, parent?.id)}
              sx={{ color: 'text.secondary', typography: 'subtitle1' }}
            >
              {slice(parent.name, 20)}
            </Link>
          ) : (
            '--'
          )}
...
CategoryDataTableRow.propTypes = {
