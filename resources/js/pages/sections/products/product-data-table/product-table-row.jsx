...
export default function ProductDataTableRow({
  row,
  selected,
  onSelectRow,
  onEditRow,
  ...
  const handlePublish = (event) => {
    router.put(route(routes.dashboard.products.update, id), {
      ...row,
          ...
          <ListItemText
            ...
            primary={
              <Link
                ...
                href={route(routes.dashboard.products.edit, id)}
